...
$settings['metadata']['facsimile-surface-desc-facsimile'] = 'Faksimile';
$settings['metadata']['facsimile-surface-desc-cover'] = 'naslovnica';
$settings['metadata']['facsimile-surface-desc-page'] = 'stran';
...
$settings['unclear-template'] = 'nejasno';
$settings['redaction-template'] = 'redakcija';
